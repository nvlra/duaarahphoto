...
export default function SettingsPage() {
  ...
  const handleDeleteLogo = async () => {
    ...
    try {
      ...
      // Parse file path from URL more robustly
      // URL format: .../storage/v1/object/public/branding/user_id/filename.ext
      const urlParts = settings.brand_logo_url.split("/branding/");
      if (urlParts.length > 1) {
        const relativePath = decodeURIComponent(urlParts[1]); // e.g. "user_id/filename.ext"
        ...
        if (storageError) {
          ...
          // We proceed to clear DB anyway, as the file might be already gone or inaccessible
        }
      }

      // AUTO-SAVE: Update the database immediately to remove the URL reference
      // This is crucial - even if storage delete fails, we must clear the bad link
        ...
        <div className="grid gap-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      onChange={(e) =>
                        handleChange("brand_color", e.target.value)
                      }
                    />
                    <Input
                      value={settings.brand_color}
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div
                      ...
                      onClick={() =>
                        handleChange("header_layout", "horizontal")
                      }
                    >
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleChange("brand_font_family", e.target.value)
                    }
                  >
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Informasi bank untuk transfer pembayaran.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleChange("bank_holder", e.target.value)
                    }
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Syarat & Ketentuan yang muncul di bagian bawah invoice.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-2">
